...
public class Ayuntamiento {
	...
	public static void main(String[] args) {
		...
		Concejal co1 = new Concejal("Blas", "87654321A", "Rep�blica do Salvador");
		concejales.add(co1);
		...
		gestorIncidencias.presentarIncidencia(ci2, "La acera est� rota", TipoIncidencia.Desperfectos);
		gestorIncidencias.presentarIncidencia(ci2, "No hay recogida de basura", TipoIncidencia.Servicios);
		gestorIncidencias.presentarIncidencia(ci3, "Republica Arxentina", "Falta una se�al", TipoIncidencia.Desperfectos);
