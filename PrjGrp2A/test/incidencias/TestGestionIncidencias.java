...
class TestGestionIncidencias {
	...
	void CP08_Prueba3_3_vincularIncidencia() {
		...
		// Assert
		assertAll(
				() -> {assertNotEquals(procesoAntiguo.getIncidencias(), procesoNuevo.getIncidencias(), "Prueba fallida, las incidencias están vinculadas a más de un proceso");},
				() -> {assertNotEquals(procesoNuevo, incidencia.getProceso(), "Prueba fallida, se ha asignado la incidencia al nuevo proceso");}
		);
	}
	...
	void CP02_Prueba8_1_buscarIncidencias() {
		...
		String dni ="12345678P";
		Ciudadano vecino = new Ciudadano("Raul", dni, "Calle callejero", "666666666");
		Incidencia incidencia = gi.presentarIncidencia(vecino, "Calle Callejero","Descripcion", TipoIncidencia.Desperfectos);
		Date fechaIni = new Date(2021 - 1900, 12, 31);
		Date fechaFin = new Date(2022 - 1900, 12, 31);
		
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias(dni, "I1", fechaIni, fechaFin, TipoIncidencia.Desperfectos);
		//Assert
		 assertTrue(obtenido.isEmpty(), "Prueba fallida, ha encontrado incidencias");
	}
	...
	void CP04_Prueba8_1_buscarIncidencias() {
		...
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias("12345678A" , "I2", fechaIni, fechaFin, TipoIncidencia.Transportes);
		//Assert
		 assertTrue(obtenido.isEmpty(), "Prueba fallida, ha encontrado incidencias");
	}
	...
	void CP05_Prueba8_1_buscarIncidencias() {
		...
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias(null , "I2", fechaIni, fechaFin, TipoIncidencia.Transportes);
		//Assert
		 assertTrue(obtenido.isEmpty(), "Prueba fallida, ha encontrado incidencias");
	}
	...
	void CP06_Prueba8_1_buscarIncidencias() {
		...
		esperado.add(incidencia);
		vecino = new Ciudadano("Pepe", "77777777Z", "Calle callejero", "666555555");
		incidencia = gi.presentarIncidencia(vecino, "Calle callejerao" , "Descripcion", TipoIncidencia.Servicios);
		
		Date fechaIni = new Date(2020 - 1900, 01, 01);
		Date fechaFin = new Date(2022 - 1900, 12, 31);
		
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias(dni , "I2", fechaIni, fechaFin, TipoIncidencia.Transportes);
		//Assert
		 assertAll(
	...
	void CP07_Prueba8_1_buscarIncidencias() {
		...
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias("12345678A" , null, fechaIni, fechaFin, TipoIncidencia.Transportes);
		//Assert
		 assertTrue(obtenido.isEmpty(), "Prueba fallida, ha encontrado incidencias");
	}
	...
	void CP08_Prueba8_1_buscarIncidencias() {
		...
		Date fechaFin = new Date(2022 - 1900, 12, 31);
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias("12345678A" , "I1", fechaIni, fechaFin, TipoIncidencia.Transportes);
		//Assert
		 assertAll(
				 () -> {assertFalse(obtenido.isEmpty(), "Prueba fallida, no ha encontrado incidencias");},
				 () -> {assertEquals(obtenido, esperado, "Prueba fallida, no se ha obtenido la incidencia esperada");}
	...
	void CP09_Prueba8_1_buscarIncidencias() {
		...
		Date fechaFin = new Date(2022 - 1900, 12, 31);
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias(null , "I1", fechaIni, fechaFin, TipoIncidencia.Transportes);
		//Assert
		 assertAll(
				 () -> {assertFalse(obtenido.isEmpty(), "Prueba fallida, no ha encontrado incidencias");},
				 () -> {assertEquals(obtenido, esperado, "Prueba fallida, no se ha obtenido la incidencia esperada");}
	...
	void CP11_Prueba8_1_buscarIncidencias() {
		...
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias("12345678A" , "I2", fechaIni, fechaFin, TipoIncidencia.Desperfectos);
		//Assert
		 assertTrue(obtenido.isEmpty(), "Prueba fallida, ha encontrado incidencias");
	}
	...
	void CP12_Prueba8_1_buscarIncidencias() {
		...
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias(null , "I2", fechaIni, fechaFin, TipoIncidencia.Desperfectos);
		//Assert
		 assertTrue(obtenido.isEmpty(), "Prueba fallida, ha encontrado incidencias");
	}
	...
	void CP13_Prueba8_1_buscarIncidencias() {
		...
		//Act
		 ArrayList<Incidencia> obtenido = gi.buscarIncidencias(null , null, fechaIni, fechaFin, TipoIncidencia.Desperfectos);
		//Assert
		//Assert
		 assertAll(
				 () -> {assertFalse(obtenido.isEmpty(), "Prueba fallida, no ha encontrado incidencias");},
